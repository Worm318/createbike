...
function listar_directorios_ruta($ruta){ 
   ...
   if (is_dir($ruta)) { 
      ...
      <td width='76' bgcolor='#EFEFEF'><a href='admin-galeria-eliminar.php?x=$file' style='color: #000; font-weight: bold;'>Eliminar</a></td>
    </tr>
...
function mostrar_descripcion($xGaleria)
{

$archivo = file_get_contents("../minishowcase/galleries/$xGaleria/_info.php"); //Guardamos archivo.txt en $archivo
...
function renombrar_carpeta($xGaleria1,$xGaleria2)
{
	rename ("../minishowcase/galleries/$xGaleria1", "../minishowcase/galleries/$xGaleria2");
}
if ($_POST[f_accion]=="GUARDAR")
{
	##renombrar Galería
	renombrar_carpeta($_GET[x],$_POST[titulo]);
	##crear descripcion
...
header("location: admin-galeria-editar.php?x=".$_POST[titulo]);
...
<body>
  ...
  <form id="submit" action="" method="post" enctype="multipart/form-data">
    ...
    <p>Título Galería:&nbsp;&nbsp;&nbsp;&nbsp;
      <input type="text" name="titulo" value="<?=$_GET[x];?>"><br>
    
    Descripción:
    <textarea id="elm1" name="descripcion"><?=mostrar_descripcion($_GET[x])?></textarea>
    </p>
    <p><br>
...
?>
    ...
    <input class="button" type="submit" value="Actualizar Galería">
...
##recorrer directorio
  ...
  <table width="500" border="0" align="center" cellpadding="2" cellspacing="2" bgcolor="#000">
    <tr>
      <td colspan="3" bgcolor="#E0E0E0" style="color: #000; font-weight: bold;">Borrar imagenes de la galería</td>
    </tr>
   
   <?php
    $directory="../minishowcase/galleries/".$_GET[x];
    ...
    while (($archivo = $dirint->read()) !== false)
    {
        if (eregi("gif", $archivo) || eregi("jpg", $archivo) || eregi("png", $archivo)){
            echo "
			<tr >
   <td align='right' bgcolor='#E0E0E0' style='text-align:right' >
			
			<img src='".$directory."/".$archivo."'>  </td>
			<td align='left' bgcolor='#E0E0E0' >
			<a href='admin-galeria-borrar.php?x=".$_REQUEST[x]."&i=".$archivo."&t=1' style='color: #000; font-weight: bold;'>BORRAR</a>
