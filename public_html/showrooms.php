...
<?php
$i = 0;
$qry= mysql_query("SELECT * FROM showrooms ORDER BY RAND()");
...
<div id="tf_loading" class="tf_loading"></div>
		...
		<div id="tf_bg" class="tf_bg">
			...
			<img src="<?php echo $value['foto']; ?>" alt="<?php echo 'image'.$value['id']; ?>" longdesc="<?php echo $value['galeria'][0]; ?>"  />	
    <?php endforeach; ?>
    ...
    <!-- //tf_bg -->
      ...
      <div class="tf_content" id="<?php echo 'content'.$value['id']; ?>" style="<?php echo 'display:'.$value['display'].';'; ?>">
				...
				<a href="<?php echo $value['foto2']; ?>" rel="lightbox-<?php echo $value['foto2']; ?>" title="<?php echo $value['descripciones'][$key2]; ?>">	<h2><?php echo $value['titulo']; ?></h2> </a>
    ...
    <?php if($value['display'] == 'block') : ?>
		<div id="tf_thumbs" class="tf_thumbs">
			...
			<a href="<?php echo $value['foto2']; ?>" rel="lightbox-<?php echo $value['foto2']; ?>" title="<?php echo $value['descripciones'][$key2]; ?>">	<img src="<?php echo $value['galeria'][0] ?>" alt="Thumb1"/> </a>
		</div>
    <?php endif; ?>
    <?php endforeach; ?>
